...
/*   Updated: 2026/09/12 16:21:06 by ahbarbou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		if (is_running(data))
// 		{
// 			if (data->number_of_coders > 1 && second->available)
// 			{
// 				acquire_dongle(coder, data, second);
// 				log_action(data, coder->id, "has taken a dongle");
// 			}
// 		}
// 	}
// 	//next plan request the two dongles in the same time modifided the 
// }

// need to see this ?

// int take_dongles(t_coder *coder, t_data *data)
// {
//     t_dongle *first;
//     t_dongle *second;
...
//     if (!acquire_dongle(coder, data, first))
//         return (0);

//     if (!acquire_dongle(coder, data, second))
//     {
